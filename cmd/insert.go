...
func init() {
	...
	insertCmd.PersistentFlags().StringVarP(&amqQueue, "queue", "q", "", "queue to write the message into")
	insertCmd.PersistentFlags().StringVarP(&amqMessage, "message", "m", "", "message to send")
